import{_ as e}from"./preload-helper.8b70a8dd.js";import{l as n}from"./vendor.7d2999dd.js";n("142Aq9",{value:!0},async()=>{const[{default:t},{default:r}]=await Promise.all([e(()=>import("./MainDisplay.12b9d463.js"),["assets/MainDisplay.12b9d463.js","assets/Header.47e3a24d.js","assets/vendor.7d2999dd.js"]),e(()=>import("./client.e66485df.js"),["assets/client.e66485df.js","assets/vendor.7d2999dd.js"])]);return(o,i)=>r(o)(t,{content:{title:"Athena Farming Controller",description:"Some simple farming system for the Athena Framework - Free, Customizable and Open Source!",author:"Der Lord!",version:"3.0.4+",images:["https://user-images.githubusercontent.com/82890183/148943871-d2df632e-1235-4ea5-af79-01e63857e41a.png"],keywords:["free","player","server","system","item"],url:"https://github.com/Booster1212/AthenaFarmController",discord:"Der Lord!#6021",astro:{headers:[{depth:1,slug:"athenafarmcontroller",text:"AthenaFarmController"},{depth:1,slug:"features",text:"Features"},{depth:1,slug:"setup",text:"Setup"}],source:`# AthenaFarmController
...
`,html:`<h1 id="athenafarmcontroller">AthenaFarmController</h1>
...
<ul>
<li>Tools with durability (Build your own)</li>
<li>Build Custom Routes with custom item returns</li>
<li>Random item returns so each time you farm you\u2019ll get another item maybe</li>
<li>Build different spots</li>
<li>Anti \u201CE-KEY\u201D Macro</li>
<li>Random farming times</li>
</ul>
