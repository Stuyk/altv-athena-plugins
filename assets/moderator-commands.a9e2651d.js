...
<h3 id="info">Info</h3>
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token operator">/</span>info <span class="token punctuation">[</span><span class="token keyword">in</span><span class="token operator">-</span>game id<span class="token punctuation">]</span></code></pre>
<h3 id="teleport-to-player">Teleport to Player</h3>
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token operator">/</span>tpto <span class="token punctuation">[</span><span class="token keyword">in</span><span class="token operator">-</span>game id<span class="token punctuation">]</span></code></pre>
<h3 id="teleport-player-to-you">Teleport Player to You</h3>
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token operator">/</span>tphere <span class="token punctuation">[</span><span class="token keyword">in</span><span class="token operator">-</span>game id<span class="token punctuation">]</span></code></pre>
<h3 id="freeze-target">Freeze Target</h3>
<p>Also kicks the player out of their vehicle if they are in one.</p>
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token operator">/</span>freeze <span class="token punctuation">[</span><span class="token keyword">in</span><span class="token operator">-</span>game id<span class="token punctuation">]</span></code></pre>
<h3 id="unfreeze-target">Unfreeze Target</h3>
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token operator">/</span>unfreeze <span class="token punctuation">[</span><span class="token keyword">in</span><span class="token operator">-</span>game id<span class="token punctuation">]</span></code></pre>
