import{_ as e}from"./preload-helper.8b70a8dd.js";import{l as s}from"./vendor.f3700654.js";s("Z2gizFn",{value:!0},async()=>{const[{default:n},{default:t}]=await Promise.all([e(()=>import("./MainDisplay.ed6cdf17.js"),["assets/MainDisplay.ed6cdf17.js","assets/Header.74d3897d.js","assets/vendor.f3700654.js"]),e(()=>import("./client.6ec4751d.js"),["assets/client.6ec4751d.js","assets/vendor.f3700654.js"])]);return(o,a)=>t(o)(n,{content:{title:"Door Lock System",description:"Door system which enables you to lock/unlock door based on a player or faction.",author:"Der Lord!",version:"3.0.0+",images:["https://user-images.githubusercontent.com/82890183/136729801-b86dc411-56e7-4d90-b8fb-a308143823b4.png"],keywords:["free","player","system","streamer","client"],url:"https://github.com/Booster1212/AthenaDoorlock",discord:"Der Lord!#6021",astro:{headers:[{depth:3,slug:"features",text:"Features"},{depth:3,slug:"how-to-use",text:"HOW TO USE"},{depth:3,slug:"setup",text:"SETUP"}],source:`
### Features
* Add Doors Ingame
* Remove Doors Ingame
* Bind to factions
...
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token keyword">import</span> <span class="token string">'./AthenaDoorlock/main'</span><span class="token punctuation">;</span>
...
<pre class="language-ts"><code data-astro-raw class="language-ts"><span class="token string">'./AthenaDoorlock/main'</span><span class="token punctuation">,</span>
